...
This file was torn from the guts of Oolite 1.75ish for use in ootranscript.
...
An action statement has two or three additional elements, all strings. The
first is the original textual representation of the condition for display
purposes. The second is a selector. If the selector ends with a colon (i.e.,
takes an argument), the third is the argument.
